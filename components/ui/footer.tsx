...
export default function Footer() {
  return (
    <footer className="bg-black text-white p-5 text-center border-gray-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Discover the beauty of Japan with our curated travel experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-600 text-sm">
              ...
              <p className="mt-2">Email: info@wanderlive.com</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-xs text-center">
            &copy; {new Date().getFullYear()} WanderLive. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
